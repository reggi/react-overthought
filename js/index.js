...
var Table = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement('input', { type: 'text', onChange: st.invokeFilter.bind(this) }),
      React.createElement(
        'table',
        null,
        React.createElement(
          StatefulChildren,
          { element: 'thead', modify: [st.onMountOrder.bind(this)] },
          React.createElement(
            'th',
            { column: 'date', onClick: st.invokeSort.bind(this)('date', 'MMMM Do, YYYY') },
            'Date'
          ),
          React.createElement(
            'th',
            { column: 'name', onClick: st.invokeSort.bind(this)('name') },
            'Name'
          )
        ),
        React.createElement(
          StatefulChildren,
          { element: 'tbody', ref: 'tbody' },
          React.createElement(
            StatefulChildren,
            { element: 'tr', modify: [st.onMountOrder.bind(this)] },
            React.createElement(
              'td',
              { column: 'name' },
              'Velma'
...
React.render(React.createElement(Table, null), document.getElementById('container'));